 ...
 */
public class DeprecatedPolarisUserDefinedEntity extends PolarisEntity {

    public static final String TYPE_SCHEMA = "type-schema";
    public static final String OBJECT = "object-definition";

    DeprecatedPolarisUserDefinedEntity(PolarisBaseEntity sourceEntity) {
        super(sourceEntity);
    }

    public static DeprecatedPolarisUserDefinedEntity of(PolarisBaseEntity sourceEntity) {
        if (sourceEntity != null) {
            return new DeprecatedPolarisUserDefinedEntity(sourceEntity);
        }
        return null;
    }

    public static DeprecatedPolarisUserDefinedEntity fromUdo(Udo udo) {
    ...
    public static class Builder extends PolarisEntity.BaseBuilder<DeprecatedPolarisUserDefinedEntity, Builder> {
        ...
        public Builder(DeprecatedPolarisUserDefinedEntity original) {
            super(original);
        }

        @Override
        public DeprecatedPolarisUserDefinedEntity build() {
            Preconditions.checkArgument(
                    properties.containsKey(TYPE_SCHEMA), "Type schema must be specified");

            return new DeprecatedPolarisUserDefinedEntity(buildBase());
        }
